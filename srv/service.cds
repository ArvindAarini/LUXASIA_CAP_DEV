...
service LuxasiaSB @(
    ...
    entity ProductCost(IP_WERKS : String(4), IP_BRAND_ID : String(18))                                                         as
        select from Product_Cost (
            IP_WERKS: :IP_WERKS, IP_BRAND_ID: :IP_BRAND_ID
        ) {
            *
        };
    ...
    entity ProductStorageUnit(IP_WERKS : String(4), IP_LGORT : String(4))                                                      as
        select from Product_StorageUnit (
            IP_WERKS: :IP_WERKS, IP_LGORT: :IP_LGORT
        ) {
            *
        };
    ...
    entity PurchaseOrder(IP_WERKS : String(4), IP_SUPP_WERKS : String(4), IP_SUPP_VEND : String(20), IP_BRAND_ID : String(18)) as
        select from Purchase_Order (
            IP_WERKS: :IP_WERKS, IP_SUPP_WERKS: :IP_SUPP_WERKS, IP_SUPP_VEND: :IP_SUPP_VEND, IP_BRAND_ID: :IP_BRAND_ID
        ) {
            *
        };
